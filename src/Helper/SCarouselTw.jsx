...
const SCarouselTw = () => {
  return (
    <div className='flex flex-col items-center'>
      <h1 className='text-center text-2xl font-bold'>MONEY ADVICE SERVICE</h1>
      <img src={MoneyAdviceServiceImage} alt="Money Advice Service" style={{ width: '170px', height: 'auto' }} />
